...
import { WEB3_AUTH_CLIENT_ID_MAINNET } from '@env';
...
export const newWeb3AuthClient = () =>
  new Web3Auth(WebBrowser, {
    clientId: __DEV__ ? WEB3_AUTH_CLIENT_ID_MAINNET : WEB3_AUTH_CLIENT_ID_MAINNET,
    network: __DEV__ ? OPENLOGIN_NETWORK.CYAN : OPENLOGIN_NETWORK.CYAN,
  });
