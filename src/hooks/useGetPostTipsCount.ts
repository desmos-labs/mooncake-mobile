 ...
 */
const useGetPostTipsCount = (post: Pick<Post, 'subspaceId' | 'id'>) => {
  ...
  const tipsDifference = useMemo(() => getPostTipsDifference(post), [getPostTipsDifference, post]);
...
export default useGetPostTipsCount;
