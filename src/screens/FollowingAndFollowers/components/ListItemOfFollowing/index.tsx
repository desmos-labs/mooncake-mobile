...
import followingQuery from '@recoil/followingAndFollowers/followingQuery';
...
/* A React component that renders a list of following accounts. */
const ListItemOfFollowing: ListRenderItem<number> = ({item: page}) => {
  ...
  const query = followingQuery({subspaceID, userAddress, cacheKey, page});
...
export default ListItemOfFollowing;
