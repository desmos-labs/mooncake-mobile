...
const TweetComponent = ({
  ...
  return (
    <DropShadowWrapper
      ...
      outerShadowProps={{distance: 10, startColor: 'white'}}>
      <TouchableOpacity
        style={[
          {padding: theme.spacing.m, borderRadius: theme.roundness},
        ...
        <Typography.Caption3>{formattedDate}</Typography.Caption3>
      </TouchableOpacity>
    </DropShadowWrapper>
  );
};
