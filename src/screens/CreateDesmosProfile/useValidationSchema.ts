...
/**
 * It returns a Yup validation schema based on the `fromSignUp` boolean and the `profileParams` object
 * @param {boolean} fromSignUp - boolean
 * @param {ProfileParams} profileParams - This is the object that contains the validation rules for the
 * profile fields.
