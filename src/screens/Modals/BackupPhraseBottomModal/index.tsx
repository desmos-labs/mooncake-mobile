...
type NavProps = StackScreenProps<RootNavigatorParamList, ROUTES.BACKUP_PHRASE_BOTTOM_MODAL>;
  ...
  return (
    <TouchableOpacity activeOpacity={1} onPress={goBack} style={styles.container}>
      ...
      <TouchableOpacity activeOpacity={1} style={styles.innerContainer}>
        ...
        <Typography.H4 style={styles.headerText}>{t('why backup')}</Typography.H4>
