...
type NavProps = StackScreenProps<RootNavigatorParamList, ROUTES.CONVERTIBLE_POINTS_MODAL>;
...
const ConvertiblePointsModal = () => {
  ...
  return (
    <BottomUpModalWrapper goBack={goBack}>
      <Typography.H4 style={styles.headerText}>{t('convertible title modal')}</Typography.H4>
